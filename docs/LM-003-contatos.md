...
Os canais oficiais ficam em `data/contato.json`.
...
`js/contatos.js` disponibiliza os dados confirmados em `window.LIGHT_CONTACT`, permitindo reutilização pela lista de interesse, formulário e demais funcionalidades públicas.
